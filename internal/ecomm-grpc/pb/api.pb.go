...
const file_api_proto_rawDesc = "" +
	...
	"\n" +
	"product_id\x18\x05 \x01(\x03R\tproductId\"\x83\x02\n" +
	"\bOrderReq\x12\x0e\n" +
	...
	"\n" +
	"user_email\x18\b \x01(\tR\tuserEmail\"\xda\x02\n" +
	"\bOrderRes\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12#\n" +
	"\x05items\x18\x02 \x03(\v2\r.pb.OrderItemR\x05items\x12%\n" +
	"\x0epayment_method\x18\x03 \x01(\tR\rpaymentMethod\x12\x1b\n" +
	...
	"is_revoked\x18\x04 \x01(\bR\tisRevoked\x129\n" +
	"\n" +
	"expires_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\texpiresAt2\x8e\a\n" +
	"\x05ecomm\x121\n" +
	"\rCreateProduct\x12\x0e.pb.ProductReq\x1a\x0e.pb.ProductRes\"\x00\x12.\n" +
	"\n" +
	"GetProduct\x12\x0e.pb.ProductReq\x1a\x0e.pb.ProductRes\"\x00\x126\n" +
	"\x0eGetAllProducts\x12\x0e.pb.ProductReq\x1a\x12.pb.ListProductRes\"\x00\x121\n" +
	...
	"\bGetOrder\x12\f.pb.OrderReq\x1a\f.pb.OrderRes\"\x00\x120\n" +
	"\fGetAllOrders\x12\f.pb.OrderReq\x1a\x10.pb.ListOrderRes\"\x00\x121\n" +
	...
	"\vGetAllUsers\x12\v.pb.UserReq\x1a\x0f.pb.ListUserRes\"\x00\x12(\n" +
	"\n" +
	...
	"\rDeleteSession\x12\x0e.pb.SessionReq\x1a\x0e.pb.SessionRes\"\x00B4Z2github.com/dockyguy56/ecomm/internal/ecomm-grpc/pbb\x06proto3"
...
var file_api_proto_depIdxs = []int32{
	...
	0,  // 14: pb.ecomm.GetAllProducts:input_type -> pb.ProductReq
	...
	4,  // 19: pb.ecomm.GetAllOrders:input_type -> pb.OrderReq
	...
	7,  // 24: pb.ecomm.GetAllUsers:input_type -> pb.UserReq
	...
	2,  // 33: pb.ecomm.GetAllProducts:output_type -> pb.ListProductRes
	...
	6,  // 38: pb.ecomm.GetAllOrders:output_type -> pb.ListOrderRes
	...
	9,  // 43: pb.ecomm.GetAllUsers:output_type -> pb.ListUserRes
