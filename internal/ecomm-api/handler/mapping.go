...
func toPBProductReq(p ProductRequest) *pb.ProductReq {
...
func toProductResponse(p *pb.ProductRes) ProductResponse {
...
func toPBOrderReq(o OrderRequest) *pb.OrderReq {
	return &pb.OrderReq{
		Id:            o.ID,
...
func toOrderResponse(o *pb.OrderRes) OrderResponse {
...
func toPBUserReq(u UserRequest) *pb.UserReq {
	return &pb.UserReq{
		Name:     u.Name,
		Email:    u.Email,
		Password: u.Password,
...
func toUserResponse(u *pb.UserRes) UserResponse {
	return UserResponse{
		Name:    u.Name,
		Email:   u.Email,
		IsAdmin: u.IsAdmin,
